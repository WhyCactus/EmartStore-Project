...
Route::middleware('regular.user')->group(function () {
    ...
    Route::get('/messages', [ClientChatController::class, 'getMessages'])->name('messages.index');
    Route::post('/messages', [ClientChatController::class, 'sendMessage'])->name('messages.store');
});
